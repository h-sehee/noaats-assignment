                ...
                >
                  ...
                  <div className="p-2 space-y-1">
                    ...
                    <button
                      ...
                      hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition"
                    >
                    ...
                    <button
                      ...
                      text-sm font-medium text-gray-700 dark:text-gray-200 text-left
                      hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition"
                    >
                  ...
                  <div className="p-2">
                    <button
                      ...
                      hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition"
                    >
                      <LogOut size={18} />
                      <span>로그아웃</span>
                    </button>
