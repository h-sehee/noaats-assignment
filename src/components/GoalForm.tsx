...
export default function GoalForm({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, monthlySaving: e.target.value })
            }
          />
        </div>
      </div>
      ...
      <button
        type="submit"
        className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-bold transition shadow-md"
      >
        목표 추가하기
      </button>
    </form>
